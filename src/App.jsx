...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    const newSubmission = { firstName, lastName, company }
  ...
  const exportToCSV = () => {
    ...
    const csvContent = [
      headers.join(','),
      ...submissions.map(sub => [sub.firstName, sub.lastName, sub.company].join(','))
    ].join('\n')
    ...
    switch (currentView) {
      ...
      case 'about':
        return (
          <div className="content-section">
            <h1>About</h1>
            <p>This is a professional contact management application built with React and Vite. It allows you to create, view, edit, and delete contact entries including first name, last name, and company information. All data is stored locally in your browser for privacy and convenience.</p>
            <p>Features:</p>
            <ul>
